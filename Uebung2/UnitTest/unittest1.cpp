...
namespace UnitTest
{
    ...
    public:
        ...
        TEST_METHOD(OrderedSetConstructor)
        {
            const int set1[] = { 3,2,4,1,5 };
            OrderedSet s1(set1, sizeof(set1) / sizeof(int));
            const int set2[] = { 1,2,3,4,5 };
        ...
        {
            const int set1[] = { 6,3,1,2,4,5 };
            OrderedSet s1(set1, sizeof(set1) / sizeof(int));
            const int set2[] = { 1,3,2 };
            OrderedSet s2(set2, sizeof(set2) / sizeof(int));
            const int set3[] = { 5,6,4 };
            OrderedSet s3(set3, sizeof(set3) / sizeof(int));

            Assert::IsTrue(s1.getSmaller(4) == s2);
            Assert::IsTrue(s3.getSmaller(4) == OrderedSet());
        }
        ...
        TEST_METHOD(GetLarger)
        {
            const int set1[] = { 6,3,1,2,4,5 };
            OrderedSet s1(set1, sizeof(set1) / sizeof(int));
            const int set2[] = { 5,6,4 };
            OrderedSet s2(set2, sizeof(set2) / sizeof(int));
            const int set3[] = { 1,3,2 };
            OrderedSet s3(set3, sizeof(set3) / sizeof(int));

            Assert::IsTrue(s1.getLarger(3) == s2);
            Assert::IsTrue(s3.getLarger(4) == OrderedSet());
        }

        TEST_METHOD(OrderedSetMerge)
        {
            const int set1[] = { 1,2,3 };
            OrderedSet s1(set1, sizeof(set1) / sizeof(int));
            const int set2[] = { 3,2,4 };
